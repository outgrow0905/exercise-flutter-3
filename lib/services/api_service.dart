...
class ApiService {
  ...
  static Future<List<WebtoonModel>> getTodaysWebtoons() async {
    ...
    final url = Uri.parse('$baseUrl/$pathToday');
  ...
  static Future<List<WebtoonEpisode>> getWebtoonEpisodes(String id) async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var episode in episodes) {
        webtoonEpisodes.add(WebtoonEpisode.fromJson(episode));
      }
